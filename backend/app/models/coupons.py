...
class Coupon(SQLModel, table=True):
    ...
    amount: float | None = Field(default=None, description="Fixed amount discount in `currency_code`")
    ...
    usage_limit: int | None = Field(default=None, description="Total times coupon can be used across all users")
