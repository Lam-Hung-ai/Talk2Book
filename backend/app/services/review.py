...
class ReviewService:
    ...
    async def get_reviews(self, skip: int = 0, limit: int = 100) -> Sequence[Review]:
    ...
    async def search_reviews(
        ...
        return await self.repo.search(
            query=query, search_columns=search_fields, skip=skip, limit=limit
        )
    ...
    async def get_target_review_stats(
        ...
        average_rating = await self.repo.get_average_rating_by_target(
